  ...
  return (
    <div className="min-h-screen flex flex-col bg-pink-50">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <h2 className="text-3xl font-semibold mb-4 text-pink-800">Welcome to My Pink App</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          />
          <Button type="submit" className="bg-pink-500 hover:bg-pink-600 text-white">Submit</Button>
        </form>
      </main>

      <footer className="bg-pink-200 p-4 text-center text-pink-800">
